...
public class CourseService {
    ...
    public List<Course> getDomainCourses(String nameInput) {
        ...
        for (ApiCourse a : raw) {
            ...
            Course course = courseMap.computeIfAbsent(code,
                    c -> new Course(c, a.getTitle(), Integer.parseInt(a.getCredits())));
    ...
    private String reorderProfessorName(String name) {
        ...
        if (name == null || name.trim().isEmpty())
            return name; // If the name is null or empty, return it as is.
